...
def playGame(wordList):
    ...
    while x == 0:
        ...
        if 'n' in word:
            hand = dealHand(n)
            handCopy = hand.copy()
            playHand(handCopy, wordList, n) # a new game
            print ''
            word = ''
        elif 'r' in word:
            if handCopy == {}:
                ...
                handCopy = hand.copy()
                playHand(handCopy, wordList, n) # restart game
                print ''
                word = ''
        elif 'e' in word:
            word = ''
            ...
            if (('n' not in word) or ('r' not in word) or ('e' not in word)):
